...
// Core contains state of the program.
type Core struct {
  humArgPtr *string
}

// NewCore instantiates a core object.
func NewCore() *Core {
  core := new(Core)
...
func (self *Core) validateHuInt(humArgPtr *string)(int) {
...
func (self *Core) rulesetStringBuilder(humArgPtr *string)(string){
  splitArr := strings.Split(*humArgPtr, " ")
